@ECHO OFF
:: Process extracts the Survey Mine Print

SET "LogErrFileName=SurveyMinePrint"

ECHO Running batch Survey Mine Print ...

CALL \\TorCwiDev01\BatchFiles\Publication\BatchInclude\MSDosServerTest.bat

SET "StartDateTime=%DateTime%"
SET "ProductType=SurveyMine"
SET "ProcessName=SurveyMinePrint"
